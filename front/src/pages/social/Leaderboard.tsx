        ...
        {leaderboard.slice(0, 3).map((user) => (
          ...
          >
            <div className="flex justify-center mb-4">
              {user.rank === 1 && (
                <span className="h-12 w-12 text-yellow-400 text-6xl">🏆</span>
              )}
              {user.rank === 2 && (
                <span className="h-12 w-12 text-gray-400 text-6xl">🥈</span>
              )}
              {user.rank === 3 && (
                <span className="h-12 w-12 text-orange-400 text-6xl">🥉</span>
              )}
            </div>
